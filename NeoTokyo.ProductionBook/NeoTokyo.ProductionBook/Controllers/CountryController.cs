...
namespace NeoTokyo.ProductionBook.Controllers
{
    public class CountryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CountryName,CountryCode")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CountryName,CountryCode")] Country country)
        {
            if (ModelState.IsValid)
            {
